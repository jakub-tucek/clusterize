...
internal class CheckQueueExecutorTest {
    ...
    fun testAllOk() {
        ...
        Mockito.`when`(queueService.retrieveQueueForUser(metadata.submittingUsername!!))
    ...
    fun testRunningWithFailedAndOkJob() {
        ...
        Mockito.`when`(queueService.retrieveQueueForUser(metadata.submittingUsername!!)).thenReturn(listOf(
